...
import { getDeviceId, savePlayerToken } from '../utils/device';
...
export function JoinRoom({ roomCode: initialCode, onJoin }: JoinRoomProps) {
  ...
  const handleJoin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      savePlayerToken(roomCode, data.write_token);
        ...
        <form onSubmit={handleJoin} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              {showEmojiPicker && (
                <div className="absolute top-full mt-2 left-0 right-0 bg-white border-2 border-gray-200 rounded-xl p-3 grid grid-cols-8 gap-2 shadow-lg z-10 max-h-48 overflow-y-auto">
